; Title: Httpserver
; Category: GUI
; Source: https://github.com/thqby/ahk2_lib/blob/master/HttpServer.ahk
; Description: #Include <compress>	; Used to support gzip/zstd compression and decompression #Include <JSON>	; https://github.com/thqby/ahk2_lib/blob/master/JSON.ahk @region http structs @lint-disable class-non-dyna
...
; 	}
; }
; Moved class HttpServerFile from nested scope
...
; Moved class HttpServerProtocol from nested scope
...
; Moved class HttpServerRequestQueue from nested scope
...
; Moved class UrlGroup from nested scope
class HttpServerUrlGroup {
    static Prototype._id := 0
...
HttpServer.File := HttpServerFile
HttpServer.Protocol := HttpServerProtocol
HttpServer.RequestQueue := HttpServerRequestQueue
HttpServer.UrlGroup := HttpServerUrlGroup
