; Title: Imageput
; Category: GUI
; Source: https://github.com/iseahound/ImagePut/blob/master/ImagePut.ahk
; Description: Script:    ImagePut.ahk License:   MIT License Author:    Edison Hua (iseahound) Github:    https://github.com/iseahound/ImagePut Date:      2025-03-15 Version:   1.11 Scroll down for a list of all ou
; Dependencies: None
...
; Moved class DesktopDuplicationBuffer from nested scope
class DesktopDuplicationBuffer extends BitmapBuffer { ; Extending is optional!
...
; Moved class BitmapBuffer from nested scope
class BitmapBuffer {
