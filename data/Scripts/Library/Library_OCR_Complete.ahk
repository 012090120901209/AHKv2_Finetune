; Title: Ocr
; Category: GUI
; Source: https://github.com/Descolada/OCR/blob/master/Lib/OCR.ahk
; Description: Example from Descolada/OCR: OCR.ahk
; Dependencies: None
...
; Moved class IBase from nested scope
class IBase {
    __OCR := OCR
    __New(ptr?) {
        if IsSet(ptr) {
...
; Moved class Result from nested scope
...
; Moved class Line from nested scope
...
; Moved class Word from nested scope
...
; Moved class Common from nested scope
class Common extends IBase {
    x {
