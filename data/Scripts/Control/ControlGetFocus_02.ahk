...
/**
 * ============================================================================
 * ControlGetFocus 02 - Focus Monitoring
 * ============================================================================
 * 
 * Demonstrates ControlGetFocus 02 functionality for window automation
 * and control manipulation.
 * 
 * @description
 * This file provides comprehensive examples of ControlGetFocus 02 usage
...
ShowMainMenu() {
    ...
    choice := InputBox(menuText, "ControlGetFocus 02 Examples", "w400 h320")
