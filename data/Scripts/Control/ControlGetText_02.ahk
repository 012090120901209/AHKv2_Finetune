...
/**
 * ============================================================================
 * ControlGetText 02 - Automation Monitoring
 * ============================================================================
 * 
 * Demonstrates ControlGetText 02 functionality for window automation
 * and control manipulation.
 * 
 * @description
 * This file provides comprehensive examples of ControlGetText 02 usage
...
ShowMainMenu() {
    ...
    choice := InputBox(menuText, "ControlGetText 02 Examples", "w400 h320")
