...
/**
 * ============================================================================
 * ControlGetPos 01 - Get Position Size
 * ============================================================================
 * 
 * Demonstrates ControlGetPos 01 functionality for window automation
 * and control manipulation.
 * 
 * @description
 * This file provides comprehensive examples of ControlGetPos 01 usage
...
ShowMainMenu() {
    ...
    choice := InputBox(menuText, "ControlGetPos 01 Examples", "w400 h320")
