...
/**
 * ============================================================================
 * ControlGetText 03 - Text Extraction
 * ============================================================================
 * 
 * Demonstrates ControlGetText 03 functionality for window automation
 * and control manipulation.
 * 
 * @description
 * This file provides comprehensive examples of ControlGetText 03 usage
...
ShowMainMenu() {
    ...
    choice := InputBox(menuText, "ControlGetText 03 Examples", "w400 h320")
