...
/**
 * ============================================================================
 * ControlGetText 01 - Read Control Text
 * ============================================================================
 * 
 * Demonstrates ControlGetText 01 functionality for window automation
 * and control manipulation.
 * 
 * @description
 * This file provides comprehensive examples of ControlGetText 01 usage
...
ShowMainMenu() {
    ...
    choice := InputBox(menuText, "ControlGetText 01 Examples", "w400 h320")
