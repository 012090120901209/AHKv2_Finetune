...
/**
 * ============================================================================
 * AutoHotkey v2 Examples - ProcessSetPriority Function (Part 01: Set priority basics)
 * ============================================================================
 * 
 * ProcessSetPriority changes a process's CPU priority level.
 * 
 * @description Examples demonstrating set priority basics
...
ShowMainMenu() {
    menu := Gui(, "ProcessSetPriority Examples (Part 01) - Main Menu")
    menu.SetFont("s10")

    menu.Add("Text", "w500", "AutoHotkey v2 - ProcessSetPriority (Set priority basics)")
    menu.SetFont("s9")
