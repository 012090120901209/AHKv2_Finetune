...
/**
 * BuiltIn_VerCompare_01_BasicComparison.ahk
 * 
 * DESCRIPTION:
 * Version string comparison with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: BasicComparison Example 1
;===============================================================================

Example1_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 1: BasicComparison")
    ...
    result .= "Description: BasicComparison\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: BasicComparison Example 2
;===============================================================================

Example2_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 2: BasicComparison")
...
;;===============================================================================
; EXAMPLE 3: BasicComparison Example 3
;===============================================================================

Example3_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 3: BasicComparison")
...
;;===============================================================================
; EXAMPLE 4: BasicComparison Example 4
;===============================================================================

Example4_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 4: BasicComparison")
...
;;===============================================================================
; EXAMPLE 5: BasicComparison Example 5
;===============================================================================

Example5_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 5: BasicComparison")
...
;;===============================================================================
; EXAMPLE 6: BasicComparison Example 6
;===============================================================================

Example6_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 6: BasicComparison")
...
;;===============================================================================
; EXAMPLE 7: BasicComparison Example 7
;===============================================================================

Example7_VerCompare() {
    ; Create GUI for VerCompare example
    gui := Gui(, "VerCompare - Example 7: BasicComparison")
