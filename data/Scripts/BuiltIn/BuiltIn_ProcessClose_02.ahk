...
/**
 * ============================================================================
 * AutoHotkey v2 Examples - ProcessClose Function (Part 02: Graceful shutdown)
 * ============================================================================
 * 
 * ProcessClose terminates a running process.
 * 
 * @description Examples demonstrating graceful shutdown
...
ShowMainMenu() {
    menu := Gui(, "ProcessClose Examples (Part 02) - Main Menu")
    menu.SetFont("s10")

    menu.Add("Text", "w450", "AutoHotkey v2 - ProcessClose (Graceful shutdown)")
    menu.SetFont("s9")
