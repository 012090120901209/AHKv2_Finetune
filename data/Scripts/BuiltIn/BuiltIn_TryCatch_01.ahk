...
/**
 * ============================================================================
 * AutoHotkey v2 Control Flow - Basic Try Catch
 * ============================================================================
 * 
 * This script demonstrates basic try catch in AutoHotkey v2.
 * Covers error handling, exception catching.
 * 
 * @file BuiltIn_TryCatch_01.ahk
...
Example1() {
    ...
    try {
        OutputDebug("  Attempting operation...`n")
        value := 10 / 2
        OutputDebug("  Result: " value "`n")
    } catch Error as err {
        OutputDebug("  Error: " err.Message "`n")
    }

    ; Error handling
    try {
        arr := [1, 2, 3]
        OutputDebug("  Item: " arr[10] "`n")
    } catch IndexError {
        OutputDebug("  Index out of bounds`n")
    }
    OutputDebug("`n")
}
