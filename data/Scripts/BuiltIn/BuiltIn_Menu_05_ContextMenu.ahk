...
/**
 * BuiltIn_Menu_05_ContextMenu.ahk
 * 
 * DESCRIPTION:
 * Context menus, right-click menus, and popup menus
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: ContextMenu - Example 1
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example1_ContextMenu() {
    myGui := Gui("+Resize", "Example 1: ContextMenu")
    ...
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 1: Demonstrates ContextMenu features")
...
;=============================================================================
; EXAMPLE 2: ContextMenu - Example 2
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example2_ContextMenu() {
    myGui := Gui("+Resize", "Example 2: ContextMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 2: Demonstrates ContextMenu features")
...
;=============================================================================
; EXAMPLE 3: ContextMenu - Example 3
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example3_ContextMenu() {
    myGui := Gui("+Resize", "Example 3: ContextMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 3: Demonstrates ContextMenu features")
...
;=============================================================================
; EXAMPLE 4: ContextMenu - Example 4
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example4_ContextMenu() {
    myGui := Gui("+Resize", "Example 4: ContextMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 4: Demonstrates ContextMenu features")
...
;=============================================================================
; EXAMPLE 5: ContextMenu - Example 5
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example5_ContextMenu() {
    myGui := Gui("+Resize", "Example 5: ContextMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 5: Demonstrates ContextMenu features")
...
;=============================================================================
; EXAMPLE 6: ContextMenu - Example 6
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example6_ContextMenu() {
    myGui := Gui("+Resize", "Example 6: ContextMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 6: Demonstrates ContextMenu features")
...
;=============================================================================
; EXAMPLE 7: ContextMenu - Example 7
;=============================================================================
; Demonstrates specific aspect of ContextMenu

Example7_ContextMenu() {
    myGui := Gui("+Resize", "Example 7: ContextMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 7: Demonstrates ContextMenu features")
