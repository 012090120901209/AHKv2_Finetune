...
/**
 * BuiltIn_Edit_01_BasicUsage.ahk
 * 
 * DESCRIPTION:
 * Basic edit control creation, text input, and retrieval
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: BasicUsage - Example 1
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example1_BasicUsage() {
    myGui := Gui("+Resize", "Example 1: BasicUsage")
    ...
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 1: BasicUsage - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 2: BasicUsage - Example 2
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example2_BasicUsage() {
    myGui := Gui("+Resize", "Example 2: BasicUsage")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 2: BasicUsage - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 3: BasicUsage - Example 3
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example3_BasicUsage() {
    myGui := Gui("+Resize", "Example 3: BasicUsage")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 3: BasicUsage - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 4: BasicUsage - Example 4
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example4_BasicUsage() {
    myGui := Gui("+Resize", "Example 4: BasicUsage")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 4: BasicUsage - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 5: BasicUsage - Example 5
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example5_BasicUsage() {
    myGui := Gui("+Resize", "Example 5: BasicUsage")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 5: BasicUsage - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 6: BasicUsage - Example 6
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example6_BasicUsage() {
    myGui := Gui("+Resize", "Example 6: BasicUsage")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 6: BasicUsage - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 7: BasicUsage - Example 7
;=============================================================================
; Demonstrates specific aspect of BasicUsage

Example7_BasicUsage() {
    myGui := Gui("+Resize", "Example 7: BasicUsage")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 7: BasicUsage - Edit control demonstration")
