...
/**
 * ============================================================================
 * AutoHotkey v2 Control Flow - Loop Ranges
 * ============================================================================
 * 
 * This script demonstrates loop ranges in AutoHotkey v2.
 * Covers parse loops, file processing, registry iteration.
 * 
 * @file BuiltIn_Loop_04.ahk
...
Example1() {
    ...
    Loop Parse, str, "," {
        OutputDebug("  Item: " A_LoopField "`n")
    }
