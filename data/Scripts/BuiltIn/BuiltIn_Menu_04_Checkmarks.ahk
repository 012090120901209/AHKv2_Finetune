...
/**
 * BuiltIn_Menu_04_Checkmarks.ahk
 * 
 * DESCRIPTION:
 * Check marks, radio items, and toggleable menu options
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: Checkmarks - Example 1
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example1_Checkmarks() {
    myGui := Gui("+Resize", "Example 1: Checkmarks")
    ...
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 1: Demonstrates Checkmarks features")
...
;=============================================================================
; EXAMPLE 2: Checkmarks - Example 2
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example2_Checkmarks() {
    myGui := Gui("+Resize", "Example 2: Checkmarks")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 2: Demonstrates Checkmarks features")
...
;=============================================================================
; EXAMPLE 3: Checkmarks - Example 3
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example3_Checkmarks() {
    myGui := Gui("+Resize", "Example 3: Checkmarks")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 3: Demonstrates Checkmarks features")
...
;=============================================================================
; EXAMPLE 4: Checkmarks - Example 4
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example4_Checkmarks() {
    myGui := Gui("+Resize", "Example 4: Checkmarks")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 4: Demonstrates Checkmarks features")
...
;=============================================================================
; EXAMPLE 5: Checkmarks - Example 5
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example5_Checkmarks() {
    myGui := Gui("+Resize", "Example 5: Checkmarks")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 5: Demonstrates Checkmarks features")
...
;=============================================================================
; EXAMPLE 6: Checkmarks - Example 6
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example6_Checkmarks() {
    myGui := Gui("+Resize", "Example 6: Checkmarks")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 6: Demonstrates Checkmarks features")
...
;=============================================================================
; EXAMPLE 7: Checkmarks - Example 7
;=============================================================================
; Demonstrates specific aspect of Checkmarks

Example7_Checkmarks() {
    myGui := Gui("+Resize", "Example 7: Checkmarks")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 7: Demonstrates Checkmarks features")
