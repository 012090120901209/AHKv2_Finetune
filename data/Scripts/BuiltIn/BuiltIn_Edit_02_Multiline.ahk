...
/**
 * BuiltIn_Edit_02_Multiline.ahk
 * 
 * DESCRIPTION:
 * Multiline edit controls, word wrap, and scrolling
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: Multiline - Example 1
;=============================================================================
; Demonstrates specific aspect of Multiline

Example1_Multiline() {
    myGui := Gui("+Resize", "Example 1: Multiline")
    ...
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 1: Multiline - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 2: Multiline - Example 2
;=============================================================================
; Demonstrates specific aspect of Multiline

Example2_Multiline() {
    myGui := Gui("+Resize", "Example 2: Multiline")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 2: Multiline - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 3: Multiline - Example 3
;=============================================================================
; Demonstrates specific aspect of Multiline

Example3_Multiline() {
    myGui := Gui("+Resize", "Example 3: Multiline")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 3: Multiline - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 4: Multiline - Example 4
;=============================================================================
; Demonstrates specific aspect of Multiline

Example4_Multiline() {
    myGui := Gui("+Resize", "Example 4: Multiline")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 4: Multiline - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 5: Multiline - Example 5
;=============================================================================
; Demonstrates specific aspect of Multiline

Example5_Multiline() {
    myGui := Gui("+Resize", "Example 5: Multiline")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 5: Multiline - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 6: Multiline - Example 6
;=============================================================================
; Demonstrates specific aspect of Multiline

Example6_Multiline() {
    myGui := Gui("+Resize", "Example 6: Multiline")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 6: Multiline - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 7: Multiline - Example 7
;=============================================================================
; Demonstrates specific aspect of Multiline

Example7_Multiline() {
    myGui := Gui("+Resize", "Example 7: Multiline")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 7: Multiline - Edit control demonstration")
