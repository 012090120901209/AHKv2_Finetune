...
/**
 * BuiltIn_Menu_02_Submenus.ahk
 * 
 * DESCRIPTION:
 * Nested menus, hierarchical structures, and submenu management
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: Submenus - Example 1
;=============================================================================
; Demonstrates specific aspect of Submenus

Example1_Submenus() {
    myGui := Gui("+Resize", "Example 1: Submenus")
    ...
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 1: Demonstrates Submenus features")
...
;=============================================================================
; EXAMPLE 2: Submenus - Example 2
;=============================================================================
; Demonstrates specific aspect of Submenus

Example2_Submenus() {
    myGui := Gui("+Resize", "Example 2: Submenus")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 2: Demonstrates Submenus features")
...
;=============================================================================
; EXAMPLE 3: Submenus - Example 3
;=============================================================================
; Demonstrates specific aspect of Submenus

Example3_Submenus() {
    myGui := Gui("+Resize", "Example 3: Submenus")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 3: Demonstrates Submenus features")
...
;=============================================================================
; EXAMPLE 4: Submenus - Example 4
;=============================================================================
; Demonstrates specific aspect of Submenus

Example4_Submenus() {
    myGui := Gui("+Resize", "Example 4: Submenus")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 4: Demonstrates Submenus features")
...
;=============================================================================
; EXAMPLE 5: Submenus - Example 5
;=============================================================================
; Demonstrates specific aspect of Submenus

Example5_Submenus() {
    myGui := Gui("+Resize", "Example 5: Submenus")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 5: Demonstrates Submenus features")
...
;=============================================================================
; EXAMPLE 6: Submenus - Example 6
;=============================================================================
; Demonstrates specific aspect of Submenus

Example6_Submenus() {
    myGui := Gui("+Resize", "Example 6: Submenus")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 6: Demonstrates Submenus features")
...
;=============================================================================
; EXAMPLE 7: Submenus - Example 7
;=============================================================================
; Demonstrates specific aspect of Submenus

Example7_Submenus() {
    myGui := Gui("+Resize", "Example 7: Submenus")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 7: Demonstrates Submenus features")
