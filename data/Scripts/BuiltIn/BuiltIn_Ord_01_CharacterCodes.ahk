...
/**
 * BuiltIn_Ord_01_CharacterCodes.ahk
 * 
 * DESCRIPTION:
 * Character to code point conversion with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: CharacterCodes Example 1
;===============================================================================

Example1_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 1: CharacterCodes")
    ...
    result := ""
    result .= "Function: Ord\n"
    result .= "Description: CharacterCodes\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: CharacterCodes Example 2
;===============================================================================

Example2_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 2: CharacterCodes")
...
;;===============================================================================
; EXAMPLE 3: CharacterCodes Example 3
;===============================================================================

Example3_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 3: CharacterCodes")
...
;;===============================================================================
; EXAMPLE 4: CharacterCodes Example 4
;===============================================================================

Example4_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 4: CharacterCodes")
...
;;===============================================================================
; EXAMPLE 5: CharacterCodes Example 5
;===============================================================================

Example5_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 5: CharacterCodes")
...
;;===============================================================================
; EXAMPLE 6: CharacterCodes Example 6
;===============================================================================

Example6_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 6: CharacterCodes")
...
;;===============================================================================
; EXAMPLE 7: CharacterCodes Example 7
;===============================================================================

Example7_Ord() {
    ; Create GUI for Ord example
    gui := Gui(, "Ord - Example 7: CharacterCodes")
