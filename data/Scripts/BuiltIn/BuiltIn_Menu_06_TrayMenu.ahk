...
/**
 * BuiltIn_Menu_06_TrayMenu.ahk
 * 
 * DESCRIPTION:
 * System tray menu customization and tray icon management
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: TrayMenu - Example 1
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example1_TrayMenu() {
    myGui := Gui("+Resize", "Example 1: TrayMenu")
    ...
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 1: Demonstrates TrayMenu features")
...
;=============================================================================
; EXAMPLE 2: TrayMenu - Example 2
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example2_TrayMenu() {
    myGui := Gui("+Resize", "Example 2: TrayMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 2: Demonstrates TrayMenu features")
...
;=============================================================================
; EXAMPLE 3: TrayMenu - Example 3
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example3_TrayMenu() {
    myGui := Gui("+Resize", "Example 3: TrayMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 3: Demonstrates TrayMenu features")
...
;=============================================================================
; EXAMPLE 4: TrayMenu - Example 4
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example4_TrayMenu() {
    myGui := Gui("+Resize", "Example 4: TrayMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 4: Demonstrates TrayMenu features")
...
;=============================================================================
; EXAMPLE 5: TrayMenu - Example 5
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example5_TrayMenu() {
    myGui := Gui("+Resize", "Example 5: TrayMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 5: Demonstrates TrayMenu features")
...
;=============================================================================
; EXAMPLE 6: TrayMenu - Example 6
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example6_TrayMenu() {
    myGui := Gui("+Resize", "Example 6: TrayMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 6: Demonstrates TrayMenu features")
...
;=============================================================================
; EXAMPLE 7: TrayMenu - Example 7
;=============================================================================
; Demonstrates specific aspect of TrayMenu

Example7_TrayMenu() {
    myGui := Gui("+Resize", "Example 7: TrayMenu")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 7: Demonstrates TrayMenu features")
