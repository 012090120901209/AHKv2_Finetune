...
/**
 * BuiltIn_DirCreate_01_BasicCreation.ahk
 * 
 * DESCRIPTION:
 * Creating directories with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: BasicCreation Example 1
;===============================================================================

Example1_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 1: BasicCreation")
    ...
    result .= "Description: BasicCreation\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: BasicCreation Example 2
;===============================================================================

Example2_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 2: BasicCreation")
...
;;===============================================================================
; EXAMPLE 3: BasicCreation Example 3
;===============================================================================

Example3_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 3: BasicCreation")
...
;;===============================================================================
; EXAMPLE 4: BasicCreation Example 4
;===============================================================================

Example4_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 4: BasicCreation")
...
;;===============================================================================
; EXAMPLE 5: BasicCreation Example 5
;===============================================================================

Example5_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 5: BasicCreation")
...
;;===============================================================================
; EXAMPLE 6: BasicCreation Example 6
;===============================================================================

Example6_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 6: BasicCreation")
...
;;===============================================================================
; EXAMPLE 7: BasicCreation Example 7
;===============================================================================

Example7_DirCreate() {
    ; Create GUI for DirCreate example
    gui := Gui(, "DirCreate - Example 7: BasicCreation")
