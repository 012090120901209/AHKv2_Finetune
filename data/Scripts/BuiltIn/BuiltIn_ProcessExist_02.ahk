...
/**
 * ============================================================================
 * AutoHotkey v2 Examples - ProcessExist Function (Part 02: Monitor)
 * ============================================================================
 * 
 * Advanced ProcessExist usage for monitoring.
 * 
 * @description Examples demonstrating monitoring techniques
...
; ============================================================================
; Example 1-7: Comprehensive process monitoring examples
; ============================================================================

Example1() {
    MsgBox("Example 1: Process monitoring Basics`n`n" .
        "Demonstrating monitoring with ProcessExist:",
...
Example2() {
    MsgBox("Example 2: Advanced monitoring`n`n" .
        "More complex monitoring scenarios:", "Example 2", "Icon!")
...
Example3() {
    gui := Gui(, "monitoring Monitor")
    gui.SetFont("s10")

    gui.Add("Text", "w400", "Process monitoring Tool")
...
Example4() {
    MsgBox("Example 4: Conditional monitoring`n`n" .
...
Example6() {
    MsgBox("Example 6: Multi-Process monitoring`n`n" .
...
Example7() {
    MsgBox("Example 7: Comprehensive monitoring System", "Example 7", "Icon!")

    gui := Gui(, "Process Management System")
    gui.SetFont("s10")

    gui.Add("Text", "w450", "Complete Process monitoring System")
...
ShowMainMenu() {
    menu := Gui(, "ProcessExist Examples (Part 02) - Main Menu")
    menu.SetFont("s10")

    menu.Add("Text", "w450", "AutoHotkey v2 - ProcessExist (Monitor)")
    menu.SetFont("s9")

    menu.Add("Button", "w450 h35", "Example 1: monitoring Basics").OnEvent("Click", (*) => (menu.Hide(), Example1(), menu.Show()))
    menu.Add("Button", "w450 h35", "Example 2: Advanced monitoring").OnEvent("Click", (*) => (menu.Hide(), Example2(), menu.Show()))
    menu.Add("Button", "w450 h35", "Example 3: monitoring Monitor").OnEvent("Click", (*) => (menu.Hide(), Example3(), menu.Show()))
    menu.Add("Button", "w450 h35", "Example 4: Conditional monitoring").OnEvent("Click", (*) => (menu.Hide(), Example4(), menu.Show()))
    menu.Add("Button", "w450 h35", "Example 5: Wait for Process").OnEvent("Click", (*) => (menu.Hide(), Example5(), menu.Show()))
    menu.Add("Button", "w450 h35", "Example 6: Multi-Process monitoring").OnEvent("Click", (*) => (menu.Hide(), Example6(), menu.Show()))
