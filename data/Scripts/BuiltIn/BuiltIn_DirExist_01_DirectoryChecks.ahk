...
/**
 * BuiltIn_DirExist_01_DirectoryChecks.ahk
 * 
 * DESCRIPTION:
 * Directory existence checking with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: DirectoryChecks Example 1
;===============================================================================

Example1_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 1: DirectoryChecks")
    ...
    result .= "Description: DirectoryChecks\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: DirectoryChecks Example 2
;===============================================================================

Example2_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 2: DirectoryChecks")
...
;;===============================================================================
; EXAMPLE 3: DirectoryChecks Example 3
;===============================================================================

Example3_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 3: DirectoryChecks")
...
;;===============================================================================
; EXAMPLE 4: DirectoryChecks Example 4
;===============================================================================

Example4_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 4: DirectoryChecks")
...
;;===============================================================================
; EXAMPLE 5: DirectoryChecks Example 5
;===============================================================================

Example5_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 5: DirectoryChecks")
...
;;===============================================================================
; EXAMPLE 6: DirectoryChecks Example 6
;===============================================================================

Example6_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 6: DirectoryChecks")
...
;;===============================================================================
; EXAMPLE 7: DirectoryChecks Example 7
;===============================================================================

Example7_DirExist() {
    ; Create GUI for DirExist example
    gui := Gui(, "DirExist - Example 7: DirectoryChecks")
