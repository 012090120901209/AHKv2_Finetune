/**
 * ============================================================================
 * AutoHotkey v2 #MaxThreads Directive - Thread Limits
 * ============================================================================
 * 
 * @description Comprehensive examples demonstrating #MaxThreads directive
 *              for concurrency control in AutoHotkey v2
 * 
...
class MaxThreadsDemo {
    ...
    static ShowInfo() {
        ...
        info .= "Purpose:`n"
        info .= "  Thread Limits`n`n"

        info .= "Usage:`n"
        info .= "  #MaxThreads [parameters]`n`n"

        info .= "Concepts:`n"
        info .= "  • concurrency control`n"
