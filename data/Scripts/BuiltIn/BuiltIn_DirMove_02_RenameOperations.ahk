...
Example1_DirMove() {
    ...
    gui := Gui(, "DirMove - Example 1: RenameOperations")
    ...
    result .= "Description: RenameOperations\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: RenameOperations Example 2
;===============================================================================

Example2_DirMove() {
    ; Create GUI for DirMove example
    gui := Gui(, "DirMove - Example 2: RenameOperations")
...
;;===============================================================================
; EXAMPLE 3: RenameOperations Example 3
;===============================================================================

Example3_DirMove() {
    ; Create GUI for DirMove example
    gui := Gui(, "DirMove - Example 3: RenameOperations")
...
;;===============================================================================
; EXAMPLE 4: RenameOperations Example 4
;===============================================================================

Example4_DirMove() {
    ; Create GUI for DirMove example
    gui := Gui(, "DirMove - Example 4: RenameOperations")
...
;;===============================================================================
; EXAMPLE 5: RenameOperations Example 5
;===============================================================================

Example5_DirMove() {
    ; Create GUI for DirMove example
    gui := Gui(, "DirMove - Example 5: RenameOperations")
...
;;===============================================================================
; EXAMPLE 6: RenameOperations Example 6
;===============================================================================

Example6_DirMove() {
    ; Create GUI for DirMove example
    gui := Gui(, "DirMove - Example 6: RenameOperations")
