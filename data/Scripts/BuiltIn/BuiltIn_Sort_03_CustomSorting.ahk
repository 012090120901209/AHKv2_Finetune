...
/**
 * BuiltIn_Sort_03_CustomSorting.ahk
 * 
 * DESCRIPTION:
 * Custom sort criteria with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: CustomSorting Example 1
;===============================================================================

Example1_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 1: CustomSorting")
    ...
    result .= "Description: CustomSorting\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: CustomSorting Example 2
;===============================================================================

Example2_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 2: CustomSorting")
...
;;===============================================================================
; EXAMPLE 3: CustomSorting Example 3
;===============================================================================

Example3_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 3: CustomSorting")
...
;;===============================================================================
; EXAMPLE 4: CustomSorting Example 4
;===============================================================================

Example4_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 4: CustomSorting")
...
;;===============================================================================
; EXAMPLE 5: CustomSorting Example 5
;===============================================================================

Example5_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 5: CustomSorting")
...
;;===============================================================================
; EXAMPLE 6: CustomSorting Example 6
;===============================================================================

Example6_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 6: CustomSorting")
