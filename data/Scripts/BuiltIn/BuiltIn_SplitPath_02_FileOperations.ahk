...
/**
 * BuiltIn_SplitPath_02_FileOperations.ahk
 * 
 * DESCRIPTION:
 * Path-based file operations with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: FileOperations Example 1
;===============================================================================

Example1_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 1: FileOperations")
    ...
    result .= "Description: FileOperations\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: FileOperations Example 2
;===============================================================================

Example2_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 2: FileOperations")
...
;;===============================================================================
; EXAMPLE 3: FileOperations Example 3
;===============================================================================

Example3_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 3: FileOperations")
...
;;===============================================================================
; EXAMPLE 4: FileOperations Example 4
;===============================================================================

Example4_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 4: FileOperations")
...
;;===============================================================================
; EXAMPLE 5: FileOperations Example 5
;===============================================================================

Example5_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 5: FileOperations")
...
;;===============================================================================
; EXAMPLE 6: FileOperations Example 6
;===============================================================================

Example6_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 6: FileOperations")
