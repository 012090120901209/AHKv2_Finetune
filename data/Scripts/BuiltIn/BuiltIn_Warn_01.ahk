/**
 * ============================================================================
 * AutoHotkey v2 #Warn Directive - Warning System
 * ============================================================================
 * 
 * @description Comprehensive examples demonstrating #Warn directive
 *              for enable warnings, error detection in AutoHotkey v2
 * 
...
class WarnDemo {
    ...
    static ShowInfo() {
        ...
        info .= "Purpose:`n"
        info .= "  Warning System`n`n"

        info .= "Usage:`n"
        info .= "  #Warn [parameters]`n`n"

        info .= "Concepts:`n"
        info .= "  • enable warnings, error detection`n"
