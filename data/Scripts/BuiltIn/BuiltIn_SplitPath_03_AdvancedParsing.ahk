...
/**
 * BuiltIn_SplitPath_03_AdvancedParsing.ahk
 * 
 * DESCRIPTION:
 * Advanced path manipulation techniques with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: AdvancedParsing Example 1
;===============================================================================

Example1_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 1: AdvancedParsing")
    ...
    result .= "Description: AdvancedParsing\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: AdvancedParsing Example 2
;===============================================================================

Example2_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 2: AdvancedParsing")
...
;;===============================================================================
; EXAMPLE 3: AdvancedParsing Example 3
;===============================================================================

Example3_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 3: AdvancedParsing")
...
;;===============================================================================
; EXAMPLE 4: AdvancedParsing Example 4
;===============================================================================

Example4_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 4: AdvancedParsing")
...
;;===============================================================================
; EXAMPLE 5: AdvancedParsing Example 5
;===============================================================================

Example5_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 5: AdvancedParsing")
...
;;===============================================================================
; EXAMPLE 6: AdvancedParsing Example 6
;===============================================================================

Example6_SplitPath() {
    ; Create GUI for SplitPath example
    gui := Gui(, "SplitPath - Example 6: AdvancedParsing")
