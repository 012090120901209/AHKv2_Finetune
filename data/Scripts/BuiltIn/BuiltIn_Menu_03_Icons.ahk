...
/**
 * BuiltIn_Menu_03_Icons.ahk
 * 
 * DESCRIPTION:
 * Adding icons to menu items from various sources
 * 
 * FEATURES:
...
;=============================================================================
; EXAMPLE 1: Icons - Example 1
;=============================================================================
; Demonstrates specific aspect of Icons

Example1_Icons() {
    myGui := Gui("+Resize", "Example 1: Icons")
    ...
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 1: Demonstrates Icons features")
...
;=============================================================================
; EXAMPLE 2: Icons - Example 2
;=============================================================================
; Demonstrates specific aspect of Icons

Example2_Icons() {
    myGui := Gui("+Resize", "Example 2: Icons")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 2: Demonstrates Icons features")
...
;=============================================================================
; EXAMPLE 3: Icons - Example 3
;=============================================================================
; Demonstrates specific aspect of Icons

Example3_Icons() {
    myGui := Gui("+Resize", "Example 3: Icons")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 3: Demonstrates Icons features")
...
;=============================================================================
; EXAMPLE 4: Icons - Example 4
;=============================================================================
; Demonstrates specific aspect of Icons

Example4_Icons() {
    myGui := Gui("+Resize", "Example 4: Icons")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 4: Demonstrates Icons features")
...
;=============================================================================
; EXAMPLE 5: Icons - Example 5
;=============================================================================
; Demonstrates specific aspect of Icons

Example5_Icons() {
    myGui := Gui("+Resize", "Example 5: Icons")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 5: Demonstrates Icons features")
...
;=============================================================================
; EXAMPLE 6: Icons - Example 6
;=============================================================================
; Demonstrates specific aspect of Icons

Example6_Icons() {
    myGui := Gui("+Resize", "Example 6: Icons")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 6: Demonstrates Icons features")
...
;=============================================================================
; EXAMPLE 7: Icons - Example 7
;=============================================================================
; Demonstrates specific aspect of Icons

Example7_Icons() {
    myGui := Gui("+Resize", "Example 7: Icons")
    ...
    ; Additional controls
    infoText := myGui.Add("Text", "xm y+20 w400",
        "Example 7: Demonstrates Icons features")
