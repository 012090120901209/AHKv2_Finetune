...
;=============================================================================
; EXAMPLE 1: UndoRedo - Example 1
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example1_UndoRedo() {
    myGui := Gui("+Resize", "Example 1: UndoRedo")
    ...
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 1: UndoRedo - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 2: UndoRedo - Example 2
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example2_UndoRedo() {
    myGui := Gui("+Resize", "Example 2: UndoRedo")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 2: UndoRedo - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 3: UndoRedo - Example 3
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example3_UndoRedo() {
    myGui := Gui("+Resize", "Example 3: UndoRedo")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 3: UndoRedo - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 4: UndoRedo - Example 4
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example4_UndoRedo() {
    myGui := Gui("+Resize", "Example 4: UndoRedo")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 4: UndoRedo - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 5: UndoRedo - Example 5
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example5_UndoRedo() {
    myGui := Gui("+Resize", "Example 5: UndoRedo")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 5: UndoRedo - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 6: UndoRedo - Example 6
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example6_UndoRedo() {
    myGui := Gui("+Resize", "Example 6: UndoRedo")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 6: UndoRedo - Edit control demonstration")
...
;=============================================================================
; EXAMPLE 7: UndoRedo - Example 7
;=============================================================================
; Demonstrates specific aspect of UndoRedo

Example7_UndoRedo() {
    myGui := Gui("+Resize", "Example 7: UndoRedo")
    ...
    ; Additional features
    infoText := myGui.Add("Text", "xm y+10 w400",
        "Example 7: UndoRedo - Edit control demonstration")
