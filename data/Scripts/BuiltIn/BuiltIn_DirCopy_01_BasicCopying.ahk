...
/**
 * BuiltIn_DirCopy_01_BasicCopying.ahk
 * 
 * DESCRIPTION:
 * Directory copy operations with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: BasicCopying Example 1
;===============================================================================

Example1_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 1: BasicCopying")
    ...
    result .= "Description: BasicCopying\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: BasicCopying Example 2
;===============================================================================

Example2_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 2: BasicCopying")
...
;;===============================================================================
; EXAMPLE 3: BasicCopying Example 3
;===============================================================================

Example3_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 3: BasicCopying")
...
;;===============================================================================
; EXAMPLE 4: BasicCopying Example 4
;===============================================================================

Example4_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 4: BasicCopying")
...
;;===============================================================================
; EXAMPLE 5: BasicCopying Example 5
;===============================================================================

Example5_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 5: BasicCopying")
...
;;===============================================================================
; EXAMPLE 6: BasicCopying Example 6
;===============================================================================

Example6_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 6: BasicCopying")
...
;;===============================================================================
; EXAMPLE 7: BasicCopying Example 7
;===============================================================================

Example7_DirCopy() {
    ; Create GUI for DirCopy example
    gui := Gui(, "DirCopy - Example 7: BasicCopying")
