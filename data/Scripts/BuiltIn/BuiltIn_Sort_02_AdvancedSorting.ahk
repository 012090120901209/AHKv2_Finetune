...
/**
 * BuiltIn_Sort_02_AdvancedSorting.ahk
 * 
 * DESCRIPTION:
 * Advanced sorting techniques with comprehensive examples demonstrating
...
;;===============================================================================
; EXAMPLE 1: AdvancedSorting Example 1
;===============================================================================

Example1_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 1: AdvancedSorting")
    ...
    result .= "Description: AdvancedSorting\n"
    result .= "Example: 1\n\n"
...
;;===============================================================================
; EXAMPLE 2: AdvancedSorting Example 2
;===============================================================================

Example2_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 2: AdvancedSorting")
...
;;===============================================================================
; EXAMPLE 3: AdvancedSorting Example 3
;===============================================================================

Example3_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 3: AdvancedSorting")
...
;;===============================================================================
; EXAMPLE 4: AdvancedSorting Example 4
;===============================================================================

Example4_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 4: AdvancedSorting")
...
;;===============================================================================
; EXAMPLE 5: AdvancedSorting Example 5
;===============================================================================

Example5_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 5: AdvancedSorting")
...
;;===============================================================================
; EXAMPLE 6: AdvancedSorting Example 6
;===============================================================================

Example6_Sort() {
    ; Create GUI for Sort example
    gui := Gui(, "Sort - Example 6: AdvancedSorting")
